...
//       <div className="bg-white bg-opacity-90 rounded-xl shadow-2xl p-8 sm:p-10 lg:p-12 max-w-full mx-auto">
//         {/* Package Title */}
//         <h1 className="text-3xl font-bold text-center text-blue-600 mb-6 sm:text-4xl lg:text-5xl">
//           {data.itinerary?.camping}
//         </h1>
...
//         {/* Pass the verticalCards to ImageCardsWithVerticalView */}
//         <div>
//           {data.verticalCards && (
//             <ImageCardsWithVerticalView verticalCards={data.verticalCards} />
//           )}
...
//         {data.inclusions && (
//           <div className="mb-8">
//             <h2 className="text-2xl font-semibold text-green-600 mb-4 sm:text-3xl lg:text-4xl">Inclusions ✅</h2>
//             <ul className="list-disc pl-5 space-y-2">
...
//       {/* Grid layout with responsive columns for images */}
//       {data.imageUrls && (
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//           {data.imageUrls.map((image, index) => (
//             <div key={index} className="flex justify-center">
